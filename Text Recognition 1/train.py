...
dataset_params = {
    'name': 'hw',
    'data_root': r'G:\Text Recognition 1\dataset',  
    'train_annotation': r'G:\Text Recognition 1\dataset\train\train.txt', 
    'valid_annotation': r'G:\Text Recognition 1\dataset\val\val.txt'   
}
...
params = {
    ...
    'export': r'G:\Text Recognition 1\weight\seq2seqocr.pth',  
    'metrics': 500 
}
